            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Goal Booster BBB Commissions Table</h4>
                            </div>
                        </div>
                        <br>
                        <div class="row mt-2">
                                    ...
                                    <tr>
                                        <?php
                                            ...
                                            foreach ($order->proceeds() as $proceed){
                                                $item = \App\BbbItem::find($proceed->item_id);
                                        ...
                                        <td>
                                            <a href="{{route('bbb_proceed_list_page',['id'=>$order->id])}}" target="_blank">
