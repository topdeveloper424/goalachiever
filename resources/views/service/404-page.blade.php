      ...
      <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="row" style="width: 50vw">
          <div class="col-sm-12 text-center">
            <img src="{{asset('app-assets/img/gallery/error.png')}}" alt="" class="img-fluid error-img mt-2" height="300"
              width="500">
            <h1 class="text-white mt-4">404 - Page Not Found!</h1>
            <button class="btn btn-primary btn-lg mt-3"><a href="{{route('home')}}" class="text-decoration-none text-white">Back
                To Home</a></button>
          </div>
        </div>
      </div>
