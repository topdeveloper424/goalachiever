...
@section('title')
    Real Estate purchase Closing cost
@endsection
...
@section('content')
    ...
    <div class="content-wrapper"><!--Statistics cards Starts-->
        <form action="{{route('update_purchase')}}" method="post">
            ...
            <input type="hidden" name="id" id="goal_id" value="{{$purchase->id}}">
            <input type="hidden" name="type" id="type" value="{{$purchase->type}}">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-5">
                                    <h4 class="card-title" id="basic-layout-colored-form-control">Real Estate purchase Closing cost</h4>
                                </div>
                                <div class="col-md-5">
                                    <button type="button" class="btn btn-danger gradient-pomegranate round mr-4" style="float: right" onclick="cashAlert({{$purchase->id}})"><i class="ft-alert-circle mr-1"></i>Cash Alert</button>
                                    <button type="button" class="btn btn-primary gradient-crystal-clear round mr-4" style="float: right" onclick="creditAlert({{$purchase->id}})"><i class="ft-credit-card mr-1"></i>Credit Alert</button>
                                </div>
                                <div class="col-md-2">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" name="goal_achieved" id="goal_achieved" @if($purchase->goal_achieved == true) checked @endif>
                        ...
                        <div class="card-content">
                            <div class="row mt-4 px-3 text-right">
                                ...
                                <div class="col-md-4 text-center">
                                    <a href="https://home-valuation-4891.secure-clix.com/" target="_blank"><button type="button" class="btn round mr-4 action-buttion grad-content">RECEIVE UP TO $2K CASH CREDIT/REQUEST QUOTE</button></a>
                                </div>
                            </div>
                                    ...
                                    <div class="px-3">
                                        <table class="table table-bordered">
                                                ...
                                                <td class="grad-right">
                                                    <select class="form-control grad-right"  style="color: black;" name="type" required>
                                                        @foreach($goal_types as $goal_type)
                                                            <option value="{{$goal_type->id}}" @if($purchase->type == $goal_type->id) selected @endif>{{$goal_type->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="grad-right"><input type="number" class="form-control grad-right" name="purchase_price" id="purchase_price" value="{{$purchase->purchase_price}}" onchange="changePurchasePrice()"></td>
                                            </tr>
                                            <tr>
                                                <td class="grad-left">Estimated closing cost credit</td>
                                                <td class="grad-right"><input type="number" class="form-control grad-right" name="purchase_credit" id="purchase_credit" value="{{$purchase->purchase_credit}}" readonly></td>
                                            </tr>
                                            </tbody>
                                        </table>
    ...
    <input type="hidden" id="curID" name="goal" value="{{$purchase->id}}">
