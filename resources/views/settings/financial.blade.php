...
@section('content')
    ...
    <div class="content-wrapper"><!--Statistics cards Starts-->
        <form action="{{route('update_financial')}}" method="post">
            @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-5">
                                <h4 class="card-title" id="basic-layout-colored-form-control">Financial Goal</h4>
                            </div>
                            <div class="col-md-5">
                                <button type="button" class="btn btn-danger gradient-pomegranate round mr-4" style="float: right" onclick="cashAlert({{$financial->id}})"><i class="ft-alert-circle mr-1"></i>Cash Alert</button>
                                <button type="button" class="btn btn-primary gradient-crystal-clear round mr-4" style="float: right" onclick="creditAlert({{$financial->id}})"><i class="ft-credit-card mr-1"></i>Credit Alert</button>
                            </div>
                            <div class="col-md-2">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" name="goal_achieved" id="goal_achieved" @if($financial->goal_achieved == true) checked @endif>
                    ...
                    <input type="hidden" name="id" id="goal_id" value="{{$financial->id}}">
                    <input type="hidden" name="type" id="type" value="{{$financial->type}}">
                    ...
                    <div class="card-content px-3">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12" style="display: inline-flex">
                                ...
                                <input type="date" class="form-control grad-right" style="color: black;" value="{{$financial->start_date}}" id="start_date" name="start_date" onchange="changeStartDate()" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12" style="display: inline-flex">
                        ...
                        <?php
                        $start_date= $financial->start_date;
                        $passed = 0;
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12" style="display: inline-flex">
                                        ...
                                        <select class="form-control grad-right" style="color: black;" name="type" required>
                                            @foreach($goal_types as $goal_type)
                                                <option value="{{$goal_type->id}}" @if($financial->type == $goal_type->id) selected @endif>{{$goal_type->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12" style="display: inline-flex">
                                        ...
                                        <input type="number" class="form-control grad-right" style="color: black;" value="{{$financial->cost}}" name="cost" id="cost" required onchange="changeCost()">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12" style="display: inline-flex">
                                        <label class="form-control grad-left" style="color: white;">Goal Time Frame(Months)</label>
                                        <input type="number" class="form-control grad-right" style="color: black;" value="{{$financial->time_frame}}" name="time_frame" id="time_frame" required onchange="changeTimeFrame()">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12" style="display: inline-flex">
                                        <label class="form-control grad-left" style="color: white; width: 70%">Monthly Saving Goals</label>
                                        <input type="number" class="form-control grad-right" style="color: black;width: 30% " value="{{$financial->saving_goals}}" name="saving_goals" id="saving_goals" required readonly>
                                    </div>
                                </div>
                                <?php
                                    $total_con = 0;
                                ...
                                <?php $balance = $financial->cost - $total_con;
                                $reached = 0;
                                if ($financial->cost != 0){
                                    $reached = round($total_con*100/$financial->cost);
                                }
                                ?>
                                <div class="row">
                                    <div class="col-md-12" style="display: inline-flex">
    ...
    <input type="hidden" id="curID" name="goal" value="{{$financial->id}}">
