                                    ...
                                    @foreach($financials as $financial)
                                        <tr>
                                            ...
                                            if ($financial->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$financial->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($financial->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$financial->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($educationals as $educational)
                                        <tr>
                                            ...
                                            if ($educational->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$educational->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($educational->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$educational->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($careers as $career)
                                        <tr>
                                            ...
                                            if ($career->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$career->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($career->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$career->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($personals as $personal)
                                        <tr>
                                            ...
                                            if ($personal->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$personal->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($personal->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$personal->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($weights as $weight)
                                        <tr>
                                            ...
                                            if ($weight->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$weight->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($weight->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$weight->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($vacations as $vacation)
                                        <tr>
                                            ...
                                            if ($vacation->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$vacation->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($vacation->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$vacation->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($insurances as $insurance)
                                        <tr>
                                            ...
                                            if ($insurance->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$insurance->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($insurance->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$insurance->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($retirements as $retirement)
                                        <tr>
                                            ...
                                            if ($retirement->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$retirement->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($retirement->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$retirement->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($purchases as $purchase)
                                        <tr>
                                            ...
                                            if ($purchase->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$purchase->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($purchase->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$purchase->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                    ...
                                    @foreach($mortgages as $mortgage)
                                        <tr>
                                            ...
                                            if ($mortgage->cash_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$mortgage->cash_alert_time)->format('m/d/Y h:i:s A');
                                            }
                                            $credit_time = "";
                                            if ($mortgage->credit_alert_time){
                                                $achived_time = Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$mortgage->credit_alert_time)->format('m/d/Y h:i:s A');
                                            }
