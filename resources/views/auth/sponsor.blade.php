                                            ...
                                            <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 px-4 pt-3 bg-white">
                                                        <h4 class="card-title mb-3">Create Sponsor Account</h4>
                                                        ...
                                                        <input type="text" name="name2" id="name2" class="form-control mb-3" @error('name2') is-invalid @enderror" value="{{ old('name2') }}" required autocomplete="name2" placeholder="Company Name" />
                                                        @error('name2')
                                                        <div class="alert alert-danger mb-2" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </div>
                                                        ...
                                                        <input type="text" name="address1" id="address1" class="form-control mb-2" @error('address1') is-invalid @enderror" value="{{ old('address1') }}" required autocomplete="address1" placeholder="Company Address" />
                                                        @error('address1')
                                                        <div class="alert alert-danger mb-2" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </div>
                                                        ...
                                                        <span class="small">Type Of Business : </span>
                                                        ...
                                                        <?php $types = \App\TypeBusiness::all(); ?>
