                                        ...
                                        <div class="card-body register-img">
                                            ...
                                            <div class="row m-0">
                                                ...
                                                <div class="col-lg-6 col-md-12 px-4 pt-3 bg-white">
                                                    <h4 class="card-title mb-3">Create Member Account</h4>
                                                    <input type="text" name="name" id="name" class="form-control mb-3" @error('name') is-invalid @enderror" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Full Name" />
                                                    @error('name')
                                                    ...
                                                    <input type="text" name="phone" id="phone" class="form-control mb-2" @error('phone') is-invalid @enderror" value="{{ old('phone') }}" required autocomplete="phone" placeholder="Contact #" />
                                                    @error('phone')
                                                    <div class="alert alert-danger mb-2" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                                    ...
                                                    <select class="form-control mb-3" id="city" name="city" @error('city') is-invalid @enderror" value="{{ old('city') }}">
                                                    </select>
                                                    @error('city')
                                                    <div class="alert alert-danger mb-2" role="alert">
                                                        <strong>{{ $message }}</strong>
