            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Sponsors Table</h4>
                            </div>
                            <div class="col-md-6">
                            ...
                            <table class="table table-striped table-bordered file-export">
                                ...
                                @foreach($sponsors as $sponsor)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="success p-0" data-toggle="tooltip" data-placement="top" title="Edit this contact" onclick="editOne({{$sponsor->id}})">
                                                <i class="ft-edit-2 font-medium-3 mr-2"></i>
                                            </a>
                                            <a class="danger p-0" data-toggle="tooltip" data-placement="top" title="Remove this contact" onclick="removeOne({{$sponsor->id}})">
