                            ...
                            <table class="table table-striped table-bordered file-export">
                                ...
                                @foreach($vendors as $vendor)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="success p-0" data-toggle="tooltip" data-placement="top" title="Edit this contact" onclick="editOne({{$vendor->id}})">
                                                <i class="ft-edit-2 font-medium-3 mr-2"></i>
                                            </a>
                                            <a class="danger p-0" data-toggle="tooltip" data-placement="top" title="Remove this contact" onclick="removeOne({{$vendor->id}})">
