            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Goal Booster Purchase Plan Table</h4>
                            </div>
                        </div>
                        <br>
                        <div class="row mt-2">
                                    ...
                                    <tr>
                                        <?php
                                            ...
                                            foreach ($order->proceeds() as $proceed){
                                                $item = \App\GoalBoosterItem::find($proceed->item_id);
                                        ...
                                        <td>
                                            <a href="{{route('goalBooster_proceed_list_page',['id'=>$order->id])}}" target="_blank">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var htm = "YTD Purchased Price : " + $("#ytd_price").val();
        ...
        function onFilter() {
            ...
            var url = "{{route('goalBooster_ur_page')}}?";
            if (from_date != ""){
