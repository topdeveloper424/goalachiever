            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Subscription Item Table</h4>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="modal fade text-left" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="form" method="post" action="{{route('save_subscription_item')}}">
                    @csrf
...
@section('script')
    ...
    <script>
        ...
        function editOne(id) {
            ...
            $.ajax({
                type: "get",
                url: '{{route('get_subscription_item')}}',
                data: {
                    id: id
                },
        ...
        function removeOne(id) {
            swal({
                ...
                if (isConfirm) {
                    $.post("{{route('remove_subscription_item')}}",{
                        _token:'{{csrf_token()}}',
                        id:id,
                    }).done(
                        function (data) {
