                        ...
                        <div class="card-body card-dashboard table-responsive">
                            <table class="table table-striped table-bordered file-export">
                                ...
                                @foreach($proceeds as $proceed)
                                    <?php $item = \App\SubscriptionItem::find($proceed->item_id); ?>
                                    <tr>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>{{ $item->cost }}</td>
                                        <td>
                                            <a class="success p-0" href="{{route('subscription_proceed_page',['id'=>$item->id])}}" data-toggle="tooltip" data-placement="top" title="Go to this proceed page" target="_blank">
