...
@section('title')
    Apparel Ultimate Rewards Credits
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Apparel UR Credits Table</h4>
                            </div>
                        </div>
                        <br>
                        <div class="row mt-2">
                        ...
                        <div class="row text-center mt-2 mb-4">
                            <div class="col-md-12">
                                <span class="badge badge-primary" id="ytd_25k_label"></span>
                                <span class="badge badge-success" id="ytd_monthly_label"></span>
                                <span class="badge badge-danger" id="ytd_sponsor_label"></span>
                            </div>
                            <div class="col-md-12 mt-2">
                                <span class="badge badge-info" id="ytd_parti_label"></span>
                            </div>
                        </div>
                        ...
                        <div class="card-body card-dashboard table-responsive">
                            <table class="table table-striped table-bordered file-export">
                                ...
                                <tr>
                                    ...
                                    <th>UR-25k-Credits</th>
                                    <th>UR-Monthly-Credits</th>
                                    <th>UR-Sponsor-Credits</th>
                                    <th>UR-School Participant-Credits</th>
                                    <th>Item List</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <?php
                                            ...
                                            foreach ($order->proceeds() as $proceed){
                                                ...
                                                if ($item->ur_type == 'URK-C'){
                                                    $total_25k += $item->quantity_sold;
                                                }elseif($item->ur_type == 'URM-C'){
                                                    $total_monthly += $item->quantity_sold;
                                                }elseif($item->ur_type == 'URS-C'){
                                                    $total_sponsor += $item->quantity_sold;
                                                }elseif ($item->ur_type == 'URSP-C'){
                                                    $total_parti += $item->quantity_sold;
                                                }
                                            }
                                            $ytd_25k += $total_25k;
                                            $ytd_monthly += $total_monthly;
                                            $ytd_sponsor += $total_sponsor;
                                            $ytd_parti += $total_parti;
                            ...
                            <input type="hidden" id="ytd_25k" value="{{$ytd_25k}}">
                            <input type="hidden" id="ytd_monthly" value="{{$ytd_monthly}}">
                            <input type="hidden" id="ytd_sponsor" value="{{$ytd_sponsor}}">
                            <input type="hidden" id="ytd_parti" value="{{$ytd_parti}}">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var htm = "YTD UR-25k-Credits : " + $("#ytd_25k").val();
            $("#ytd_25k_label").html(htm);

            var htm = "YTD UR-Monthly-Credits : " + $("#ytd_monthly").val();
            $("#ytd_monthly_label").html(htm);

            var htm = "YTD UR-Sponsor-Credits : " + $("#ytd_sponsor").val();
            $("#ytd_sponsor_label").html(htm);

            var htm = "YTD UR-School Participant-Credits : " + $("#ytd_parti").val();
            $("#ytd_parti_label").html(htm);
