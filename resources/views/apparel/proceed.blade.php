                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">Apparel Proceeds</h4>
                        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td colspan="2" class="grad-left">Unit Price</td>
                                            <td class="grad-right" id="unit_price">{{$item->unit_price}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="grad-left">Cost</td>
                                            <td class="grad-right" id="cost">{{$item->cost}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" class="grad-left">Profit Margin</td>
                                            <td class="grad-right" id="profit_margin">{{$item->profit_margin}}%</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">Sales Projection:</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="grad-left">Qty-Sold</td>
                                            <td class="grad-right" id="qty_sold">{{$item->quantity_sold}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="grad-left">Net Profit</td>
                                            <td class="grad-right" id="net_profit">{{$item->net_profit}}</td>
                                        ...
                                        <tr>
                                            <td colspan="2" class="grad-left">Total Net Profit</td>
                                            <td class="grad-right" id="total_net_profit">{{$item->total_net_profit}}</td>
                                        </tr>
                                        <tr><td colspan="3">&nbsp;</td></tr>
                                        <tr><td colspan="3">&nbsp;</td></tr>
