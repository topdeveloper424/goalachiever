            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Apparel Proceeds List Table</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body card-dashboard table-responsive">
                            <table class="table table-striped table-bordered file-export">
                                ...
                                @foreach($proceeds as $proceed)
                                    <?php $item = \App\ApparelItem::find($proceed->item_id); ?>
                                    <tr>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>{{ $item->cost }}</td>
                                        <td>
                                            <a class="success p-0" href="{{route('apparel_proceed_page',['id'=>$item->id])}}" data-toggle="tooltip" data-placement="top" title="Go to this proceed page" target="_blank">
